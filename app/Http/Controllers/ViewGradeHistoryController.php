...
class ViewGradeHistoryController extends Controller
{
    public function joinHistory(){
        ...
        {
        $data = Grade_change::join('grades','grades.id_of_grade','=','grade_change.id_grade')
        ...
        return view('grade_history', compact('name, previous_grade','data'));
        ...
        else
        {
            $data = Grade_change::join('grades','grades.id_of_grade','=','grade_change.id_grade')
            ->join('users','users.id','=','grades.id_user')
            ->get(['grades.id_of_grade','grades.grade_value','grade_change.previous_grade', 'grades.comment', 'grade_change.history_created_at', 'grades.created_at']);
